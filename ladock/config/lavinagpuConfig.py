...
# 5. Adjust the parameters in the 'config_lavinagpu.txt' file as needed. Set the MGLTools installation directory and docking parameters in this file correctly.
